...
const LoginForm = ({ 
  ...
  const handleLogin = async (e) => {
    ...
    setLoading(true);
    const result = await login(credentials.username, credentials.password, true); // Pass true to suppress toast
    ...
    if (result.success && onLoginSuccess) {
      ...
      setErrorDialog({
        open: true,
        message: result.error || 'Incorrect username or password. Please try again.'
      });
    }
